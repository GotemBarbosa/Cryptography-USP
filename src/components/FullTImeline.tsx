      ...
      <div className="relative z-10 flex flex-col w-screen h-full min-h-screen font-mono  bg-slate-900 bg-gradient-to-tr from-cyan-900/50 via-slate-800/10 to-slate-900 ">
        ...
        <div className="relative">
          <VerticalTimeline lineColor="rgb(39 39 42)" layout="1-column-left">
            ...
            <TimelineElement date="Séc IX d. C. ">
              <div className="flex font-poppins justify-center items-center flex-col gap-5">
                ...
                <div className="flex font-poppins justify-center items-center flex-row gap-5 px-5">
                  <p className="text-justify">
                    Durante a época de ouro islâmica, o acesso ao conhecimento
                    foi mais abrangente e sua busca encorajada, isso permitiu
                    que muitos grandes estudiosos se formassem, sendo um deles
                    Al-Kindi. Al-Kindi foi responsável pela tradução de muitos
                    textos e mensagens criptografadas de origem grega e romana,
                    mas graças ao seu acesso a estudos de Linguagem, Estatística
                    e Matemática, ele foi capaz de desenvolver um método para
                    descobrir o conteúdo de mensagens criptografadas, sendo
                    método a Análise de Frequência. Como o próprio nome diz, ele
                    tem como princípio ver qual o símbolo mais recorrente na
                    mensagem e substituí-lo pela letra mais recorrente na
                    língua,o segundo símbolo mais recorrente pela segunda letra
                    mais recorrente e assim em diante. Tal método era tão
                    eficiente que a cifra de césar foi facilmente decifrada por
                    esse método, tornando-a ineficiente.
                  </p>
            ...
            <TimelineElement date="Séc IX d. C. ">
              <div className="flex font-poppins justify-center items-center flex-col gap-5">
                <p className="text-justify">Século XX</p>
                <p>
                  Lorem, ipsum dolor sit amet consectetur adipisicing elit.
                  Aliquid quos enim consequatur ea similique minus ipsa iure eos
                  voluptate magnam harum, iusto aperiam asperiores
                  necessitatibus aspernatur nisi quisquam culpa at.
                </p>
                ...
                <div className="flex w-full gap-5">
                  ...
                  {/* <img alt="" src={CryptexImg} className='rounded-lg w-[400px]'/> */}
                </div>
              </div>
            </TimelineElement>
